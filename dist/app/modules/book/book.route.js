...
router.post("/", (0, auth_1.default)("user"), book_controller_1.BookControllers.createBook);
...
router.delete("/:productId", (0, auth_1.default)("user"), book_controller_1.BookControllers.deleteBook);
router.put("/:productId", (0, auth_1.default)("user"), book_controller_1.BookControllers.updateBook);
